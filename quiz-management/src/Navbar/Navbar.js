...
const Navbar = ({
    ...
    // Cập nhật editedUser khi currentUser thay đổi
    useEffect(() => {
        if (currentUser) {
            console.log('🔄 Navbar useEffect - User data:', currentUser);
            setEditedUser({
                name: currentUser.name || currentUser.username || '',
                email: currentUser.email || '',
                phone: currentUser.phone || '',
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (updateUser) {
                    console.log('📢 Calling updateUser with:', data.user);
                    updateUser(data.user);
                } else {
                    console.warn('⚠️ updateUser is not available!');
                }
                    ...
                    <div className="navbar-menu">
                        {navItems.map((item) => (
                            <div key={item.name} className="navbar-item-wrapper">
                                ...
                                {item.name === "Danh sách" && (
                                    <div className="dropdown-menu">
                                        <a href="#" className="dropdown-item" onClick={(e) => { e.preventDefault(); onShowTeachers(); }}>
                                            Giảng viên
                                        </a>
                                        <a href="#" className="dropdown-item" onClick={(e) => { e.preventDefault(); onShowStudents(); }}>
                                            Sinh viên
                                        </a>
                                    </div>
                                )}
                                ...
                                {item.name === "Ngân hàng đề" && (
                                    <div className="dropdown-menu">
                                        <a
                                            href="#"
                                            className="dropdown-item"
                                            onClick={(e) => { e.preventDefault(); onShowExamBank("tracnghiem"); }}
                                        >
                                            Trắc nghiệm
                                        </a>
                                    </div>
                                ...
                                {item.name === "Tạo bài thi" && (
                                    <div className="dropdown-menu">
                                        <a
                                            href="#"
                                            className="dropdown-item"
                                            onClick={(e) => { e.preventDefault(); onShowCreateExam("tracnghiem"); }}
                                        >
                                            Trắc nghiệm
                                        </a>
                                    </div>
